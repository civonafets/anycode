...
| M-055 | Knowledge Compilation, Concept Graph, and Derived Views | P1 | 2 - Broker + Tooling | Planned | [`M-055-knowledge-compilation-concept-graph-and-derived-views.md`](./M-055-knowledge-compilation-concept-graph-and-derived-views.md) |
| M-056 | Markdown Vault Projection and Filesystem Sync | P1 | 2 - Broker + Tooling | Planned | [`M-056-markdown-vault-projection-and-filesystem-sync.md`](./M-056-markdown-vault-projection-and-filesystem-sync.md) |
