...
| F-006 | Approval Workflow and Conversation | P0 | 3 - Standalone Surfaces | Planned | [`F-006-approval-workflow-conversation.md`](./F-006-approval-workflow-conversation.md) |
| F-007 | Dashboard MVP | P1 | 3 - Standalone Surfaces | Planned | [`F-007-dashboard-mvp.md`](./F-007-dashboard-mvp.md) |
| F-008 | Mobile Inbox PWA | P1 | 3 - Standalone Surfaces | Planned | [`F-008-mobile-inbox-pwa.md`](./F-008-mobile-inbox-pwa.md) |
| F-009 | Codex CLI Wrapper Integration | P0 | 2 - Broker + Tooling | Planned | [`F-009-codex-cli-wrapper.md`](./F-009-codex-cli-wrapper.md) |
| F-010 | Claude Code Wrapper Integration | P0 | 2 - Broker + Tooling | Planned | [`F-010-claude-code-wrapper.md`](./F-010-claude-code-wrapper.md) |
| F-011 | Codex App Guided Integration | P1 | 3 - Standalone Surfaces | Planned | [`F-011-codex-app-guided-integration.md`](./F-011-codex-app-guided-integration.md) |
...
2. Status change: update row here and reflect details in feature file.
3. Work start/stop: update `IN_PROGRESS.md`.
